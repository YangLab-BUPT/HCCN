...
with open('/data/csyData/uniprot_test/data/XML_testdata/go_temp/GO_data/bpo/withlayer/sta_count3.json') as f:
    sta_count4 = json.load(f)
...
for go,value in sta_count4.items():
    alpha[go] = value['count1']
