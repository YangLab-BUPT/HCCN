...
# 聚类（可选，用于配色）
labels_concat = KMeans(n_clusters=10).fit_predict(concat_emb)

# t-SNE 降维
z_concat_2d = TSNE(n_components=2, perplexity=50).fit_transform(concat_emb)
...
plt.savefig('./image/concat_tsne.png')